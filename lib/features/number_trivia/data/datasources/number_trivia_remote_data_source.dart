...
class NumberTriviaRemoteDataSourceImpl extends NumberTriviaRemoteDataSource {
  ...
  @override
  Future<NumberTriviaModel> getConcreteNumberTrivia(int number) => _getNumberTrivia(url: 'http://numbersapi.com/$number');

  @override
  Future<NumberTriviaModel> getRandomNumberTrivia() => _getNumberTrivia(url: 'http://numbersapi.com/random');
}
